 ...
 const ToggleButtone = ({setOpen}) => {
   return (
     <button onClick={()=>setOpen(prev=>!prev)}>
      <svg width="29" height="23" viewBox='0 0 23 23'>
        ...
        d="M 2 9.432 L 20 9.432" variants={{closed:{opacity:1}, open:{opacity:0}}}/>
